    ...
    return (
      <div className="row btn-toolbar customers-toolbar" role="toolbar" >
        <nav className="container-fluid navbar navbar-expand-xl">
          ...
          <div className="view-menu btn-group btn-group-sm d-none d-md-block" role="group" >
            <button type="button"
          ...
          <div className="filter-menu btn-group btn-group-sm d-none d-lg-block" role="group" >
